...
//顶部电影基础信息
  ...
  Widget buildRectItem(double marginLeft, String title) {
    return Container(
      decoration: BoxDecoration(color: Util.whiteColor, borderRadius: BorderRadius.circular(3.0)),
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                Text(
                  '已看过？记录此刻感受',
                  style: TextStyle(color: Util.whiteColor, fontSize: 13),
                ),
                Container(width: 20),
                Image.asset(
        ...
        child: Column(
          children: <Widget>[
              ...
              child: Row(
                  ...
                  children: <Widget>[
                    Expanded(
                        child: Text('豆瓣评分™',
                            style:
                                TextStyle(color: Util.whiteColor, fontSize: 11.0))),
                    Image.asset(
                      'images/arrow_right.png',
                      height: 25,
                      fit: BoxFit.cover,
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(color: Util.whiteColor, fontSize: 8.0),
                        ),
                      )
                    ],
                  ),
            ...
            Container(
              ...
              child: Text(
                '372人看过  638人想看',
                style: TextStyle(color: Util.whiteColor, fontSize: 10.0),
              ),
            )
          ],
        ));
                ...
                return Column(
                  children: <Widget>[
                    ...
                    Text(
                      ...
                      style: TextStyle(color: Util.whiteColor, fontSize: 13, fontWeight: FontWeight.w500),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                  ],
      ...
      children: <Widget>[
        Container(
          ...
          child: TabBar(
            ...
            indicatorColor: Util.whiteColor,
            isScrollable: false,
            labelPadding: EdgeInsets.all(0),
            tabs: <Widget>[
              Tab(child: Text('电影', style: TextStyle(color: Util.whiteColor),)),
              Tab(child: Text('片单', style: TextStyle(color: Util.whiteColor),))
            ],
          ),
        ),
        Container(
          ...
          child: TabBarView(
            controller: _tabController,
            children: <Widget>[
              Center(child: Text("TabbarView11111", style: TextStyle(color: Util.whiteColor),),),
              Center(child: Text("TabbarView22222", style: TextStyle(color: Util.whiteColor),),),
            ],
          ),
        )
      ], 
